...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('public/backend/lib/tagsinput/bootstrap-tagsinput.css') }}">
    <!-- Summernote -->
  ...
  <body>
    ...
    <script src="{{ asset('public/backend/lib/tagsinput/bootstrap-tagsinput.min.js') }}"></script>
